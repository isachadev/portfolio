export function Hero() {
  return (
    <section id="home" className="relative flex flex-col justify-center overflow-hidden pt-16 pb-12 lg:pt-24 lg:pb-24">
      ...
      <div className="px-6 lg:px-8 max-w-7xl mx-auto w-full">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col gap-6 lg:w-2/3 items-start">
            <div className="flex flex-col gap-5 text-left">
              <div className="flex flex-wrap items-center gap-3">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent/10 border border-accent/20 w-fit">
                  ...
                  <span className="text-xs font-mono font-medium text-accent uppercase tracking-wide">Available for projects</span>
                </div>
              </div>
              
              <h1 className="text-5xl sm:text-6xl font-bold leading-[1.1] tracking-tight text-white">
                Fullstack <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent via-purple-500 to-accent-dark animate-gradient-x">Developer</span>
              </h1>
              
              <p className="text-lg text-secondary leading-relaxed max-w-[640px]">
                I'm a developer who enjoys building functional and clean web applications. I focus on learning every day and creating useful tools for users. Currently helping clients worldwide on Upwork.
              </p>
            </div>
            ...
            <div className="flex flex-wrap sm:flex-nowrap items-center gap-6 sm:gap-10 pt-8 border-t border-border w-full">
              <div className="flex flex-col gap-1">
                <span className="text-3xl font-bold text-white font-mono">1+</span>
                <span className="text-xs text-secondary uppercase tracking-wider font-semibold">Year Exp.</span>
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="text-xs text-secondary uppercase tracking-wider font-semibold">Upwork Job Success</span>
              </div>
              ...
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-3xl font-bold text-white font-mono">Rising</span>
                </div>
                <span className="text-xs text-secondary uppercase tracking-wider font-semibold">Talent on Upwork</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative w-full lg:w-1/3 flex justify-center lg:justify-end">
            <div className="flex flex-col items-center gap-8">
              ...
              {/* Ultra-Minimalist Quick Navigation Icons */}
        ...
        <div className="mt-24 lg:mt-28 w-full max-w-5xl overflow-hidden relative mx-auto px-4"
             style={{ maskImage: "linear-gradient(to right, transparent, black 10%, black 90%, transparent)", WebkitMaskImage: "linear-gradient(to right, transparent, black 10%, black 90%, transparent)" }}>
          
          <div className="flex w-max animate-scroll">
            {/* Double the list to create infinite loop illusion */}
            {[...Array(2)].map((_, i) => (
              <div key={i} className="flex items-center gap-12 sm:gap-24 px-6 sm:px-12 shrink-0">
                {[
                  ...
                  <div key={`${i}-${tech.name}`} className="flex items-center gap-3 opacity-40 hover:opacity-100 transition-opacity cursor-default">
                    <span className="material-symbols-outlined text-3xl">{tech.icon}</span>
                    <span className="text-sm font-mono font-bold tracking-widest uppercase">{tech.name}</span>
                  </div>
                ))}
              </div>
            ))}
